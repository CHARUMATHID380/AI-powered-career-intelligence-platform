...
# works regardless of the working directory it's launched from (this matters
# on serverless platforms like Vercel, where the cwd isn't guaranteed to be
# the project root).
# ---------------------------------------------------------------------------
...
#
# NLTK data download: only /tmp is writable on serverless platforms like
...
if _model is not None and not _nltk_ready:
